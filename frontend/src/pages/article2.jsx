export default function Article2() {
    ...
    <>
        <article>
        <h1>Lykke i Norden: Hva kan Norge lære av Finland?</h1>
            <section class="section1">
                <p>Er gresset virkelig grønnere på den andre siden av grensen? Nye tall avslører at Norge, 
            ...
            <section class="section3">
                <h2>To sider av samme mynt: Finland vs. Norge</h2>
            ...
            <section class="section4">
                <h2>“I Finland er balanse nøkkelen”</h2>
            ...
            <section class="section5">
                <h2>Andrea's norske realitet</h2>
            ...
            <section class="section6">
                <h2>Veien til lykke: Kan Norge lære av Finland?</h2>
        ...
        {/* Midlertidig map */}
        <article>
            <h3>Lykkeindeksen 2024: En visuell oversikt</h3>
            ...
            <section>
                <div style="min-height:392px" id="datawrapper-vis-nLQfN"><script type="text/javascript" defer src="https://datawrapper.dwcdn.net/nLQfN/embed.js" charset="utf-8" data-target="#datawrapper-vis-nLQfN"></script><noscript><img src="https://datawrapper.dwcdn.net/nLQfN/full.png" alt="" /></noscript></div>
                <figcaption>Kartet viser den globale lykkeindeksen for 2024, der land er fargekodet fra rødt (lavest lykkenivå) til blått (høyest lykkenivå). 
                ...
                <p>Norden utmerker seg med sine konsekvente blåtoner, som tyder på høye lykkenivåer. 
                    ...
                    å se forbi tradisjonelle økonomiske målestokker.
                </p>
            </section>
        </article>
     </>
