    ...
    return (
        <>
            ...
            <section className="content">
                ...
                <figure>
                    <LineChart id="chart1" labels={lineChartData.labels} datasets={lineChartData.datasets} />
            ...
            <section className="content">
                ...
                <figure>
                    <BarChart id="chart2" labels={barChartData.labels} datasets={barChartData.datasets} />
