  ...
  return (
    <>
      ...
      <section className="content">
        ...
        <p>Konsekvensene av å stå utenfor arbeidslivet er ikke bare begrenset til tap av inntekt...</p>
        <figure>
      ...
      <section className="content">
        <h2>Veien videre</h2>
        <p>Fagbrev bør ikke være en blindvei. De unge, ambisiøse menneskene som har investert fire år i sin utdanning, fortjener bedre...</p>
      </section>
